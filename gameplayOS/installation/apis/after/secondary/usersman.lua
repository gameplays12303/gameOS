function mkuser(username,isadmin,password,background,taskbar)
    ...
    then
        ...
        sys.makefile(path,username,isadmin,password,background,taskbar)
...
function getpassword(username)
    ...
    then
        ...
        error("not allowed to use users_system",2)
    end
